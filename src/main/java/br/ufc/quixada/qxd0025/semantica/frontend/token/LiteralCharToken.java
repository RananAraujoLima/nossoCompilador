...
/**
 * Classe que representa um token do tipo (CHARL).
 */
public class LiteralCharToken extends Token{
    /**
    ...
    public LiteralCharToken(long line, long start, String value) throws IllegalArgumentException {
