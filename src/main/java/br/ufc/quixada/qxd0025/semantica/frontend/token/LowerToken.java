...
/**
 * Classe que representa um token do tipo (LT).
 */
public class LowerToken extends Token{
    /**
    ...
    public LowerToken(long line, long start, String value) throws IllegalArgumentException {
